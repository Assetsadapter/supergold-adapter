...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO SPG", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "W3EpBpHBCpgJxPpofe3f5JChFhr13CJwKF")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "W3EpBpHBCpgJxPpofe3f5JChFhr13CJwKF"
	account := &openwallet.AssetsAccount{Alias: "mainnetSPG", WalletID: walletID, Required: 1, Symbol: "SPG", IsTrust: true}
...
func TestWalletManager_GetAssetsAccountList(t *testing.T) {
	...
	walletID := "VyeUFV8YYPcZdXD8DkJc96K3TK5cLaHjqj"
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "W3EpBpHBCpgJxPpofe3f5JChFhr13CJwKF"
	accountID := "FhEL7DtDCFknghAA33U3f7n8BueeM6xXMGKkyjhZ8nsx"
...
func TestWalletManager_GetAddressList(t *testing.T) {
	...
	walletID := "VyeUFV8YYPcZdXD8DkJc96K3TK5cLaHjqj"
	accountID := "CYc866Ss2WhkYCB6Axsxy6oWnftjybJhcxS1UAsJ29cT"
