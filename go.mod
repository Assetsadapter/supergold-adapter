...
require (
	...
	github.com/blocktree/bitcoin-adapter v1.4.2
	github.com/blocktree/go-owcdrivers v1.1.28
	github.com/blocktree/go-owcrypt v1.0.3
	github.com/blocktree/litecoin-adapter v1.3.1
...
replace github.com/blocktree/go-owcdrivers v1.1.28 => github.com/Assetsadapter/go-owcdrivers v1.1.27
